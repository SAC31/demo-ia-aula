          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-base text-slate-600 md:text-lg">
                Ferramenta interativa para mostrar diferenças, benefícios e impacto da qualidade do prompt.
              </p>
            </div>
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <div className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-2xl font-semibold text-slate-900">Demonstração de Prompt</h2>
              <div className="flex rounded-2xl bg-slate-100 p-1 text-sm">
                <button
                  className={`rounded-xl px-3 py-2 ${selected === 'prompt' ? 'bg-white shadow-sm' : ''}`}
            ...
            <div className="mt-6 grid gap-4">
              <div className="rounded-2xl border border-slate-200 p-4">
                <p className="text-sm font-semibold text-slate-500">Prompt fraco</p>
                <p className="mt-2 text-sm text-slate-800">{examples.fraco.prompt}</p>
                <p className="mt-4 text-sm font-semibold text-slate-500">Resposta gerada</p>
                <p className="mt-2 text-sm text-slate-700">{examples.fraco.resposta}</p>
              </div>
              <div className="rounded-2xl border border-slate-200 p-4">
                <p className="text-sm font-semibold text-slate-500">Prompt forte</p>
                <p className="mt-2 text-sm text-slate-800">{examples.bom.prompt}</p>
                <p className="mt-4 text-sm font-semibold text-slate-500">Resposta gerada</p>
                <p className="mt-2 text-sm text-slate-700">{examples.bom.resposta}</p>
              </div>
            </div>
          </div>
          ...
          <div className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between gap-3">
              <h2 className="text-2xl font-semibold text-slate-900">Assistente virtual vs Chatbot</h2>
              <div className="flex rounded-2xl bg-slate-100 p-1 text-sm">
                <button
            ...
            {mode === 'chatbot' ? (
              <div className="mt-6 rounded-2xl border border-slate-200 p-4">
                ...
                <div className="mt-3 space-y-3 text-sm">
                  <div className="rounded-2xl bg-slate-100 p-3">Aluno: O que é inteligência artificial?</div>
                  <div className="rounded-2xl bg-slate-900 p-3 text-white">Chatbot: É a capacidade de sistemas computacionais realizarem tarefas que normalmente exigem inteligência humana.</div>
                </div>
              ...
              <div className="mt-6 rounded-2xl border border-slate-200 p-4">
                <p className="text-sm font-semibold text-slate-500">Exemplo</p>
                <div className="mt-3 space-y-3 text-sm">
                  <div className="rounded-2xl bg-slate-100 p-3">Professor: Prepara um quiz de 5 perguntas sobre IA para esta turma, com dificuldade média e correção automática.</div>
                  <div className="rounded-2xl bg-slate-900 p-3 text-white">Assistente virtual: Criei um quiz com 5 perguntas, opções de resposta, solução correta e critérios de correção. Posso também adaptá-lo ao tempo de aula.</div>
                </div>
                <p className="mt-4 text-sm text-slate-600">
        ...
        <section className="rounded-3xl bg-white p-6 shadow-sm border border-slate-200">
          ...
          <div className="mt-4 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl bg-slate-50 p-4">
              ...
              <p className="mt-2 text-sm text-slate-600">Apresentar os conceitos e as diferenças entre IA, prompt, chatbot e assistente virtual.</p>
            </div>
            <div className="rounded-2xl bg-slate-50 p-4">
              <p className="text-sm font-semibold text-slate-800">2. Demonstrar</p>
              <p className="mt-2 text-sm text-slate-600">Mostrar ao vivo como a qualidade do prompt altera a utilidade da resposta.</p>
            </div>
            <div className="rounded-2xl bg-slate-50 p-4">
              <p className="text-sm font-semibold text-slate-800">3. Envolver</p>
              <p className="mt-2 text-sm text-slate-600">Pedir aos alunos para melhorarem um prompt fraco e discutirem o resultado.</p>
            </div>
          </div>
        </section>
      </div>
